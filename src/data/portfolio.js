...
export const projects = [
  { featured: true, title: "VCFO", subtitle: "AI-Powered Financial Intelligence Platform", role: "Founder & CTO", description: "A financial intelligence platform transforming accounting data into structured insights, analytics, and CFO-level intelligence.", technologies: ["NestJS", "React.js", "Next.js", "TypeScript", "PostgreSQL", "Redis", "RabbitMQ", "Prisma", "AWS", "Docker", "AI / RAG"], tags: "NestJS · React.js · Next.js · TypeScript · PostgreSQL · Redis · RabbitMQ · Prisma · AWS · Docker · AI / RAG", link: "https://vcfo-ai.com/" },
...
export const companies = [
  ...
  { id: "volt-lines", name: "Volt Lines", icon: faBus, logo: "assets/volt-lines-logo.svg", link: "https://www.linkedin.com/company/18321317/", type: "Full-time", location: "Istanbul, Türkiye", roles: [
  ...
  { id: "youthink", name: "YouThink Academy powered by WozU", icon: faChalkboardUser, logo: "assets/wozu-logo.svg", link: "https://www.linkedin.com/company/38080729/", type: "Full-time", location: "Istanbul, Türkiye", roles: [
  ...
  { id: "wide-scope", name: "Wide Scope", icon: faMobileScreenButton, logo: "assets/wide-scope-logo.svg", link: "https://www.linkedin.com/company/1901583/", type: "Full-time", mode: "Hybrid", location: "Istanbul, Türkiye", roles: [
